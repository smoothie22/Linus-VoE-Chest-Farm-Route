...
del ".\Linus_VoE_Chest_Farm-dev.taco"
...
"%ProgramFiles%\WinRAR\WinRAR.exe" a -afzip -ep1 -ibck -r -y ".\Linus_VoE_Chest_Farm-dev.zip" ".\Data" ".\Linus_VoE_Chest_Farm.xml"

:: renames the zip to taco
rename "Linus_VoE_Chest_Farm.zip" "Linus_VoE_Chest_Farm.taco"
rename "Linus_VoE_Chest_Farm-dev.zip" "Linus_VoE_Chest_Farm-dev.taco"
